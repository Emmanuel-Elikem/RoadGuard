...
class TextToSpeed extends StatefulWidget {
  const TextToSpeed({super.key});

  @override
  State<TextToSpeed> createState() => _TextToSpeedState();
}

enum TtsState { playing, stopped, paused, continued }

class _TextToSpeedState extends State<TextToSpeed> {
